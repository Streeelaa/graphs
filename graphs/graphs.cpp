...
// graphs.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CgraphsApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CgraphsApp::OnAppAbout)
...
CgraphsApp::CgraphsApp() noexcept
{
	...
	SetAppID(_T("graphs.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CgraphsApp

CgraphsApp theApp;


// Инициализация CgraphsApp
...
// Обработчики сообщений CgraphsApp
...
public:
	...
	afx_msg void OnBnClickedButtonChangeAxis();
};
...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	ON_WM_SIZE()
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_BUTTON_CHANGE_AXIS, &CAboutDlg::OnBnClickedButtonChangeAxis)
END_MESSAGE_MAP()
...
void CAboutDlg::OnBnClickedButtonChangeAxis()
{
